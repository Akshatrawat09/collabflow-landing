	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'pulse-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(267 89% 65% / 0.3)' },
					'50%': { boxShadow: '0 0 40px hsl(267 89% 65% / 0.6)' }
				},
				'bounce-3d': {
					'0%, 100%': { 
				...
				'tilt': {
					...
					'25%': { transform: 'perspective(1000px) rotateY(1deg) rotateX(1deg)' },
			...
			animation: {
				...
				'bounce-3d': 'bounce-3d 3s ease-in-out infinite',
